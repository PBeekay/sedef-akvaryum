...
export const products: Product[] = [
  ...
  {
    id: 'fish-tropical-set',
    name: 'Tropikal Balık Seti',
    category: 'fish',
    price: 45.99,
    description: 'Tetralar ve lepistesler dahil 5 renkli tropikal balık seti. Bu balıklar topluluk tankları için mükemmel ve herhangi bir akvaryuma güzel renkler katar.',
    shortDescription: 'Tetralar ve lepistesler dahil 5 renkli tropikal balık seti.',
