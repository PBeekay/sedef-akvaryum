                ...
                <div className="flex-1">
                    {['fish', 'shrimp'].includes(product.category) ? (
                        ...
                        <WhatsAppButton
                            ...
                            className="w-full py-3 justify-center text-sm font-bold shadow-md bg-green-500 hover:bg-green-600 text-white rounded-xl"
                        >
                            <span className="flex items-center gap-2">
                        ...
                        <WhatsAppButton
                            ...
                            className="w-full py-3 justify-center text-sm font-bold shadow-md bg-gray-500 hover:bg-gray-600 text-white rounded-xl"
                        >
                            <span className="flex items-center gap-2">
                                <span>🔔</span>
                                Gelince Haber Ver
