...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  phoneNumber = "+905315073006", // Sedef Akvaryum telefon numarası
  className = "",
  children,
  variant = "inline"
}) => {
    ...
    return (
      <>
        ...
        <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-lg">
          <button
            onClick={handleWhatsAppClick}
            className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-6 flex items-center justify-center gap-3 transition-colors"
